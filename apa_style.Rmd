...
#load("all_data.RData", envir = myEnv)
#myEnv <- new.env()
...
include_graphics("figures_doc/studydesign_new.png")
```
...
include_graphics("figures_doc/sessionprotocol.png")
```
...
```{r fig5, fig.cap="A simple discrete Bayesian network contain nodes, possible states of the nodes and the arcs connecting nodes.", fig.pos="H", out.width="100%", fig.align='center'}

include_graphics("figures_doc/examplenetwork.png")
...
RI provided the highest BIC value (`r rstmodel[1,2]`), compared to RR (`r rstmodel[2,2]- rstmodel[1,2]`), GDP (`r rstmodel[4,2]-  rstmodel[1,2]`) and I (`r rstmodel[5,2] - rstmodel[1,2]`).
...
The three lowest and highest conditional probabilities based on all the variables in injured_2 Markov blanket are presented in Table \ref{tab:table8} (complete results in S5 Table).
