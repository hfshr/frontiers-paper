...
Each participant was asked to attend a total of four data collections over a twelve-month period, with each data collection separated by a four-month interval (Fig \ref{fig:fig3}). 
